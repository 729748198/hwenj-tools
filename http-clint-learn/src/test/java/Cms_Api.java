...
public class Cms_Api {
   ...
   // public static final String url = "https://k01.weishi110.cn:19994/cloudapi/v2/intelligence/basic";
...
//            result = EntityUtils.toString(entity, "UTF-8");
    ...
    public void attack() throws Exception{
        ...
        List<NameValuePair> nvps = new ArrayList<NameValuePair>();
        Map<String, Object> paramMap = buildParam();
        paramMap.put("host","223.104.211.201");
        if (null != paramMap && paramMap.size() > 0) {
            // 以下代码使用实现类BasicNameValuePair生成NameValuePair
            // 通过map集成entrySet方法获取entity
            Set<Map.Entry<String, Object>> entrySet = paramMap.entrySet();
    ...
    public static Map<String, Object> buildParam() {
        ...
        String machineId = "623627996D2DC14F08F394ECBAA1FA58";
        String authCode = "FD7ALPE3L5CGMFE2AU5F8ZP7B86YYB6V";
