...
//        return new JedisCluster(getSet(),10000,5000,10,redisPoolProperties.getPassword(),initPoolConfig());
//    }
    ...
    public JedisPool getRedisPool() {
        return new JedisPool(initPoolConfig(), "127.0.0.1", 6379,3000,redisPoolProperties.getPassword());
    }
